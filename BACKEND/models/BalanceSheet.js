...
const balanceSchema = new mongoose.Schema({
    ...
    assets: {
        ...
        fixed_assets: {
            ...
            accumulated_depreciation: { type: Number, default: 0, max: 0 } // Always negative
        },
        other_assets: {
        ...
        total_assets: { type: Number, required: true, min: 0 }
    },
    liabilities: {
        current_liabilities: {
        ...
        total_liabilities: { type: Number, required: true, min: 0 }
    },
    equity: {
...
balanceSchema.pre('save', function(next) {
    try {
        ...
        const fixedAssets = 
            ...
            (this.assets?.fixed_assets?.accumulated_depreciation || 0); // Already negative
...
// Add validation for the accounting equation
